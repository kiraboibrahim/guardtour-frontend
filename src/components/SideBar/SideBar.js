              ...
              <List sx={{ gap: 0.5 }}>
                {sitesLoading &&
                  <ListItem sx={{mt: 1}}>
                    ...
                    <ListItemContent><Typography level='body-sm'>Loading sites</Typography></ListItemContent>
                  </ListItem>
                }
                {sites.map(site => {
                  return (
                    <ListItem key={site.id}>
                      <ListItemButton onClick={() => setSelectedSite(site)}>{site.name}</ListItemButton>
                  </ListItem>
                  );
                })}
              </List>
